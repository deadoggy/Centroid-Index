...
def centroid_index(data, label_1, label_2, metric='euclidean',
                   prototype='center', symmetric=True):
    '''
        ...
        argv:
            ...
            @prototype:
                ...
                as the prototype.  
                Otherwise, assign a function which take two list and
                ouput two prototype. If @metric is string, prototypes should
                be np.ndarray; If @metric is function, prototypes should be
